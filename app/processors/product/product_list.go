...
func (p *productProcessor) List(ctx context.Context, limit int64, offset int64) (products []db.Product, err error) {
...
func (p *productProcessor) ListCount(ctx context.Context) (int64, error) {
